...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fateblog` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/*Data for the table `t_ad` */

insert  into `t_ad`(`id`,`title`,`pic`,`link`,`expires`,`post_time`) values (1,'声之形','/upload/201808/koenokatachi3.jpg','/posts?id=8',1553794452,1533784505);
insert  into `t_ad`(`id`,`title`,`pic`,`link`,`expires`,`post_time`) values (2,'Fate/stay night','/upload/201808/fate-saber1.jpg','/posts?id=10',1553794452,1533885505);
...
insert  into `t_admin`(`id`,`name`,`pwd`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3');
...
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (1,1,1,0,2,'动漫：《噬血狂袭》','动漫','/upload/201808/shixuekx.jpg','《噬血狂袭》，简称“血袭”（ストブラ），为三云岳斗所创作，麻喵子负责插画的日本轻小说。经由电击文库自 2011 年 5 月起出版发行。',26,1464533773);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (2,1,1,1,2,'动漫：《白色相簿 2 》','动漫','/upload/201808/whitealbum2.jpg','由游戏改编的动漫一向比较好看，这里推荐一部《白色相簿 2》。小编感觉这部动漫从人物塑造，画风到剧情都还不错。白色相簿系列发行了游戏、漫画、动画、小说、周边等，可以说很成功了。',24,1464667800);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (3,1,1,1,2,'动漫：《樱花庄的宠物女孩》','动漫','/upload/201808/sakurasou.jpg','《樱花庄的宠物女孩》（日文：さくら荘のペットな彼女）是轻小说家鸭志田一著作，插画家沟口凯吉负责插画，电击文库 （ 隶属 MediaWorks ） 所属的轻小说',6,1464754200);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (4,1,1,1,2,'动漫：《灰色的果实》','动漫|灰色三部曲','/upload/201808/grisaia.jpg','《灰色的果实》是灰色三部曲《灰色的果实》，《灰色的迷宫》，《灰色的乐园》的第一部，是日本游戏开发商 FrontWing 开发的一款成人向游戏，于 2011 年 2 月 25 日发售',6,1465543626);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (5,1,1,1,2,'动漫：《染红的街道》','动漫|空之三部曲','/upload/201808/qihongdejiedao.jpg','《染红的街道》（日语：あかね色に染まる坂）是由 feng 制作的一部游戏。',4,1468209600);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (6,1,2,1,2,'游戏：病娇模拟器','游戏','/upload/201808/bingjiaomoniqi.jpg','病娇模拟器，原名 Yandere Simulator ，这款游戏是一个自由度超高的个人项目，目前还没有开发完成，可以下载调试版试玩。',6,1486872000);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (7,1,1,1,1,'动画电影：《借东西的小人阿莉埃蒂》','动漫|动画电影','/upload/201808/jiewuxiaoren.jpg','动漫改编自英国作家玛丽·诺顿的小说作品，讲述生活在郊外房子地板下身长 10 厘米的 14 岁少女，与来此疗养的少年相识的故事。',68,1489312817);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (8,1,1,1,2,'动画电影：《声之形》','动漫|动画电影','/upload/201808/koenokatachi3.jpg','《声之形》（日语：映画 聲の形）是由京都动画制作的一部动画电影，根据大今良时的漫画《声之形》改编。于 2016 年 9 月 17 日在日本上映。',8,1503918000);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (9,1,1,1,2,'动画电影：《你的名字。》','动漫|动画电影','/upload/201808/yourname2.jpg','《你的名字。》（日语：君の名は。）是由新海诚导演的， CoMix Wave Films 制作的动画电影。并有小说、漫画等衍生作品。',16,1504263600);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (10,1,2,1,2,'游戏： Fate/stay night','fate|游戏','/upload/201808/fate.jpg','《Fate / stay night》（日语：フェイト/ステイナイト)，简称 stay night ，是由 TYPE-MOON 于 2004 年 1 月 30 日发售的 PC 平台文字冒险游戏。',14,1505127600);
insert  into `t_post`(`id`,`uid`,`nav_id`,`is_recommend`,`list_style`,`title`,`tags`,`thumb`,`brief`,`views`,`post_time`) values (11,1,1,1,2,'动画电影：《大鱼海棠》','动漫|动画电影','/upload/201808/dayuhaitang.jpg','《大鱼海棠》于 2016-07-08 上映，单从电影的构思，引入了平行世界观，有了其他种族和人类的互动，定位已经不再是老少咸宜了，主打成人市场，可以说在国产动画里很创新了。',3,1506855600);
...
/*Data for the table `t_post_comment` */
...
/*Data for the table `t_tips` */

insert  into `t_tips`(`id`,`title`,`intro`) values (1,'mediaworks','MediaWorks 是日本角川控股集团旗下以次文化、游戏为主拥有“电击”等品牌的出版社， ASCII 公司为日本一家以电脑杂志为主的出版社。2008 年 4 月 1 日， MediaWorks 吸收合并 ASCII ，商号变更为“株式会社 ASCII MEDIA WORKS”');
insert  into `t_tips`(`id`,`title`,`intro`) values (2,'niconico','niconico 动画，（日文：ニコニコ動画）由日本 Dwango 公司的子公司 Niwango 运营，以亚文化视频为主要内容的弹幕式视频分享网站');
insert  into `t_tips`(`id`,`title`,`intro`) values (3,'ova','Original Video Animation 即原创视频动画的简称，一般通过 DVD 或蓝光光碟发行，内容较精良，无时长限制，多见于番外剧集用以补充原著剧情');
insert  into `t_tips`(`id`,`title`,`intro`) values (4,'leaf','Leaf 社是出版商 Aquaplus 旗下的日本视觉小说工作室，在 Yodogawa-ku ， Osaka 和 Tokyo 设有办事处');
insert  into `t_tips`(`id`,`title`,`intro`) values (5,'tokyomx','Tokyo MX 指东京首都电视台');
insert  into `t_tips`(`id`,`title`,`intro`) values (6,'feng','feng 社是一家位于日本千叶县市川市的游戏制作公司');
insert  into `t_tips`(`id`,`title`,`intro`) values (7,'CoMix Wave Films','CoMix Wave Films，Inc。是一家日本动画电影制片厂和发行公司，总部位于日本东京千代田区。该工作室以其动漫故事片，短片和电视广告而闻名。官方网站 - http://www.cwfilms.jp');
insert  into `t_tips`(`id`,`title`,`intro`) values (8,'周目','周目（日文：しゅうめ）最开始被游戏所用，自无存档状态开始玩第一次叫一周目，第二次为二周目，以此类推。原则上不通关不算一次');
insert  into `t_tips`(`id`,`title`,`intro`) values (9,'TYPE-MOON','TYPE-MOON （中文：型月）原为日本的同人游戏社团。后来商业化， 2003 年同人社团 TYPE-MOON 解散，同时成立游戏公司 Notes. ， TYPE-MOON 成为 Notes. 旗下品牌');
...
/*Data for the table `t_topic_category` */
...
/*Data for the table `t_topic_content` */
...
/*Data for the table `t_user_credit` */

insert  into `t_user_credit`(`uid`,`score`,`experience`) values (1,105,107);
...
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('白丁',0,5,1);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('童生',6,12,2);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('案首',13,20,3);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('监生',21,30,4);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('生员',31,50,5);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('禀生',51,60,6);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('贡生',61,70,7);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('举人',71,90,8);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('解元',91,110,9);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('进士',111,130,10);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('二甲',131,160,11);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('会员',161,190,12);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('探花',191,220,13);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('榜眼',221,270,14);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('状元',271,320,15);
insert  into `t_user_level`(`levelname`,`minscore`,`maxscore`,`levelnum`) values ('大神',321,1000,16);
