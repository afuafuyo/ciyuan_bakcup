...
--
-- Host: localhost:3306
-- Generation Time: 2018-10-07 16:02:24
...
(1, 1, 1, 0, 2, '动漫：《噬血狂袭》', '动漫', '/upload/201808/shixuekx.jpg', '《噬血狂袭》，简称“血袭”（ストブラ），为三云岳斗所创作，麻喵子负责插画的日本轻小说。经由电击文库自 2011 年 5 月起出版发行。', 29, 1464533773),
(2, 1, 1, 1, 2, '动漫：《白色相簿 2 》', '动漫', '/upload/201808/whitealbum2.jpg', '由游戏改编的动漫一向比较好看，这里推荐一部《白色相簿 2》。小编感觉这部动漫从人物塑造，画风到剧情都还不错。白色相簿系列发行了游戏、漫画、动画、小说、周边等，可以说很成功了。', 30, 1464667800),
(3, 1, 1, 1, 2, '动漫：《樱花庄的宠物女孩》', '动漫', '/upload/201808/sakurasou.jpg', '《樱花庄的宠物女孩》（日文：さくら荘のペットな彼女）是轻小说家鸭志田一著作，插画家沟口凯吉负责插画，电击文库 （ 隶属 MediaWorks ） 所属的轻小说', 9, 1464754200),
(4, 1, 1, 1, 2, '动漫：《灰色的果实》', '动漫|灰色三部曲', '/upload/201808/grisaia.jpg', '《灰色的果实》是灰色三部曲《灰色的果实》，《灰色的迷宫》，《灰色的乐园》的第一部，是日本游戏开发商 FrontWing 开发的一款成人向游戏，于 2011 年 2 月 25 日发售', 21, 1465543626),
(5, 1, 1, 1, 2, '动漫：《染红的街道》', '动漫|空之三部曲', '/upload/201808/qihongdejiedao.jpg', '《染红的街道》（日语：あかね色に染まる坂）是由 feng 制作的一部游戏。', 7, 1468209600),
(6, 1, 2, 1, 2, '游戏：病娇模拟器', '游戏', '/upload/201808/bingjiaomoniqi.jpg', '病娇模拟器，原名 Yandere Simulator ，这款游戏是一个自由度超高的个人项目，目前还没有开发完成，可以下载调试版试玩。', 16, 1486872000),
(7, 1, 1, 1, 1, '动画电影：《借东西的小人阿莉埃蒂》', '动漫|动画电影', '/upload/201808/jiewuxiaoren.jpg', '动漫改编自英国作家玛丽·诺顿的小说作品，讲述生活在郊外房子地板下身长 10 厘米的 14 岁少女，与来此疗养的少年相识的故事。', 78, 1489312817),
(8, 1, 1, 1, 2, '动画电影：《声之形》', '动漫|动画电影', '/upload/201808/koenokatachi3.jpg', '《声之形》（日语：映画 聲の形）是由京都动画制作的一部动画电影，根据大今良时的漫画《声之形》改编。于 2016 年 9 月 17 日在日本上映。', 16, 1503918000),
(9, 1, 1, 1, 2, '动画电影：《你的名字。》', '动漫|动画电影', '/upload/201808/yourname2.jpg', '《你的名字。》（日语：君の名は。）是由新海诚导演的， CoMix Wave Films 制作的动画电影。并有小说、漫画等衍生作品。', 27, 1504263600),
(10, 1, 2, 1, 2, '游戏： Fate/stay night', 'fate', '/upload/201808/fate.jpg', '《Fate / stay night》（日语：フェイト/ステイナイト)，简称 stay night ，是由 TYPE-MOON 于 2004 年 1 月 30 日发售的 PC 平台文字冒险游戏。', 51, 1505127600),
(11, 1, 1, 1, 2, '动画电影：《大鱼海棠》', '动漫|动画电影', '/upload/201808/dayuhaitang.jpg', '《大鱼海棠》于 2016-07-08 上映，单从电影的构思，引入了平行世界观，有了其他种族和人类的互动，定位已经不再是老少咸宜了，主打成人市场，可以说在国产动画里很创新了。', 29, 1506855600),
(12, 1, 1, 1, 2, '动漫：《工作细胞》', '动漫', '/upload/201808/gongzuoxibao.jpg', '《工作细胞》（日语：はたらく細胞）是由日本漫画家清水茜于漫画杂志《月刊少年天狼星》（月刊少年シリウス）上连载的一部细胞拟人漫画。后由 david production 改编成电视动画。', 20, 1535628948),
(13, 1, 1, 1, 2, '《Fate / stay night》电视动画及剧场版简介', 'fate', '/upload/201809/fate.jpg', '《 Fate/stay night 》（日语：フェイト/ステイナイト)，简称 stay night ，是由 TYPE-MOON 于 2004 年 1 月 30 日发售的 PC 平台文字冒险游戏/视觉小说。游戏一共三条线路： Fate 、Unlimited Blade Works 、Heaven\'s Feel ，分别对应 Saber 、远坂凛、间桐樱三位女主角。', 49, 1535788759),
(14, 1, 1, 1, 2, '动画电影：《红辣椒》', '今敏', '/upload/201809/YVibJZ20180912055736.jpg', '《 Paprika 》（中文：红辣椒 或 盗梦侦探）是日本著名动画导演今敏所导的动画电影。于 2006 年 9 月在威尼斯国际电影节首映， 2006 年 11 月 25 日在日本放映。', 13, 1536732003),
(15, 1, 2, 0, 1, '看懂游戏分级制度', '游戏', '/upload/201809/gsrr.png', '游戏分级是一种用于分别视频游戏对各年龄人士的合适度的分级。大部份分级系统都是由政府资助非营利性组织。大部分国家都会对视频游戏做内容分级。', 11, 1537262750),
(16, 1, 1, 1, 2, 'fate 美食番《卫宫家今天的饭》', 'fate', '/upload/201809/weigongfan.jpg', '《卫宫家今天的饭》(日语：衛宮さんちの今日のごはん)是漫画家 TAa 的漫画作品。后由 ufotable 将其改变为电视动画。营造了一个温柔的世界观', 12, 1538308401);
